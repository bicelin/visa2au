...
import { Check, ArrowRight, Clock, DollarSign, FileText, Globe, Heart } from 'lucide-react';
...
const PartnerVisa309 = () => {
  ...
  const processSteps = [
    ...
    { step: 5, title: 'Permanent Visa', desc: 'We assist with the 100 permanent visa after 2 years' },
  ];
  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/80 mb-6">
              The offshore partner visa pathway allows you to apply for temporary and permanent partner visas while living outside Australia.
            </p>
            <div className="flex flex-wrap gap-4 text-white/80">
              ...
              <div className="flex items-center gap-2">
                <Globe className="w-5 h-5 text-visa-gold" />
                <span>Apply from outside Australia</span>
              </div>
            </div>
            <div className="mt-8">
      ...
      <section className="section-padding bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-visa-navy mb-6">What Is the 309/100 Visa?</h2>
              <p className="text-visa-charcoal/70 mb-6">
                The Partner (Provisional) Visa (Subclass 309) is for the partners or spouses of Australian citizens or permanent residents who are outside Australia when they apply and when the visa is granted.
              </p>
              <p className="text-visa-charcoal/70 mb-6">
                After holding the 309 visa for 2 years, you may be eligible to apply for the permanent Partner Visa (Subclass 100).
              </p>
              <div className="bg-visa-teal/10 rounded-xl p-5">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-visa-navy">Provisional Visa (309)</p>
                      <p className="text-sm text-visa-charcoal/60">Apply from outside Australia, travel when granted</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-visa-navy">Permanent Visa (100)</p>
                      <p className="text-sm text-visa-charcoal/60">Grants permanent residency after 2 years</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <ul className="space-y-3">
                {['Apply while outside Australia', 'Travel to Australia once 309 is granted', 'Live and work in Australia', 'Access to Medicare healthcare', 'Study without restrictions', 'Pathway to permanent residency', 'Include dependent children in application'].map((feature, i) => (
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-visa-charcoal/70 max-w-2xl mx-auto">
              To be eligible for the Partner Visa 309, you must meet the following criteria:
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-visa-charcoal/70 mb-6">
                We help you compile comprehensive relationship evidence:
              </p>
              <ul className="space-y-3">
            ...
            <div>
              ...
              <div className="bg-visa-navy rounded-2xl p-6 text-white">
                ...
                <ul className="space-y-4">
                  {['Complete eligibility assessment', 'Relationship evidence compilation', 'Application preparation and lodgement', 'Document review and organization', 'Interview preparation', 'Health and character compliance', 'Ongoing case management', 'Follow-up with DHA', '100 permanent visa assistance'].map((service, i) => (
                    <li key={i} className="flex items-center gap-3">
      ...
      <VisaRelatedBlog
        title="Partner Visa 309/100 Insights"
        subtitle="Expert articles and latest updates on offshore partner visa regulations and requirements"
        filterTags={['Partner Visa', '309', '100', 'Offshore', '820', '801', 'Spouse', 'Family']}
        maxPosts={3}
        showFeatured={true}
      />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
            <Link to="/visas/partner-visa-820" className="bg-white/10 backdrop-blur-sm rounded-xl p-5 hover:bg-white/20 transition-colors">
              ...
              <p className="text-white/60 text-sm">Onshore partner visa pathway</p>
            </Link>
