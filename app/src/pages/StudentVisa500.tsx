  ...
  <Layout>
    <section className="relative pt-32 pb-20 overflow-hidden">
      <div className="absolute inset-0 z-0">
        {/* Mobile: focus on Aboriginal art (left). Desktop: focus on student (right). */}
        <img
          src="/imgs/hero-student-visa-500.png"
          alt="Australian university campus at golden hour with Aboriginal art and international student"
          className="w-full h-full object-cover object-left md:object-right"
          loading="eager"
        />
        {/* Desktop: standard hero gradient */}
        <div className="absolute inset-0 hero-gradient" />
        {/* Mobile: extra dark overlay on left where text sits, over Aboriginal art */}
        <div
          className="absolute inset-0 md:hidden"
          style={{ background: 'linear-gradient(135deg, rgba(2,6,23,0.95) 0%, rgba(15,23,42,0.80) 50%, rgba(2,6,23,0.40) 100%)' }}
        />
      </div>
