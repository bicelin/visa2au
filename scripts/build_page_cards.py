...
PAGES = {
    ...
    "pricing": ("Transparent Fixed-Fee Pricing",
                ...
                "visa2.au"),
    "ru/pricing": ("Цены и стоимость виз в Австралию",
                   "Консультации $330/час · Partner visas от $5,500 · без сюрпризов",
                   "visa2.au"),
    "fr/pricing": ("Tarifs et coûts des visas australiens",
                   "Consultations 330 $/h · Visas partenaires dès 5 500 $ · sans surprise",
                   "visa2.au"),
